...
extension WaitCommand on GenericCommands {
  /// WAIT numreplicas timeout
  ///
  /// Blocks the current client until all the previous write commands are
  /// successfully
  /// transferred and acknowledged by at least the specified number of replicas.
