...
extension XReadCommand on StreamCommands {
  /// XREAD [COUNT count] [BLOCK milliseconds] STREAMS key [key ...] id [id ...]
  ///
  /// Read data from one or multiple streams.
  /// Returns a Map where Key is Stream Key, Value is List of StreamEntry.
  Future<Map<String, List<StreamEntry>>> xRead(
    List<String> keys,
    List<String> ids, {
    int? count,
    int? block,
  }) async {
    final cmd = <String>['XREAD'];
