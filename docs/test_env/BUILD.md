...
```yaml
# version: 3.5.0  # Previous version
...
Create a new release on GitHub. Use the tag you just created (e.g., `v3.6.0`). Copy the relevant section from `CHANGELOG.md` into the release notes.
