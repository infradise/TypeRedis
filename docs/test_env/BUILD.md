...
```yaml
# version: 4.5.0  # Previous version
...
Create a new release on GitHub. Use the tag you just created (e.g., `v4.5.1`). Copy the relevant section from `CHANGELOG.md` into the release notes.
